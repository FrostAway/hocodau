                        ...
                        <div id="post" class="clearfix">
                            ...
                            <div class="col-sm-12 col-lg-7 content">
                                ...
                                <table class="short-desc">
                                    ...
                                    <tr class="">
                                        <td class="lb">Tuổi</td>
                                        <td class="info"><?php echo get_post_meta(get_the_ID(), 'tutor-age', true); ?></td>
                                    </tr>
                                    <tr class="">
                                        <td>Địa chỉ</td>
                                        <td><?php echo get_post_meta(get_the_ID(), 'tutor-address', true) ?></td>
                                    </tr>
                                    <tr class="">
                                        <td>Nghề nghiệp</td>
                                        <td><?php echo get_post_meta(get_the_ID(), 'tutor-job', true) ?></td>
                                    </tr>
                                    <tr class="courses">
                                        <td>Các khóa học</td>
                        ...
                        <div class="tabs">
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="courses">
                                    ...
                                    <?php query_posts(array('post_type'=>'course', 'meta_key'=>'eng-tutor-id', 'meta_value'=>  get_the_ID())); ?>
                                    <div class="posts">
                                        <?php if (have_posts()): while (have_posts()): the_post(); ?>
                                                <div class="post row">
