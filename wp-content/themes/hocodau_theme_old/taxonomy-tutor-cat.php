        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-9 column-right">                       
                ...
                <?php global $wp_query;
                    ...
                    <?php include_once 'includes/age-filter.php'; ?>
                            ...
                            <div class="post row">
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-4 ">
                                    <table class="post-info">
                                        ...
                                        <tr>
                                            <td class="lb">Tuổi</td>
                                            <td class="info"><?= get_post_meta(get_the_ID(), 'tutor-age', true); ?></td>
                                        </tr>
                                        <tr>
                                            <td class="lb">Địa chỉ</td>
                                            <td class="info"><?= get_post_meta(get_the_ID(), 'tutor-address', true); ?></td>
                                        </tr>
                                        <tr>
                                            <td class="lb">Nghề nghiệp</td>
                                            <td class="info"><?= get_post_meta(get_the_ID(), 'tutor-job', true); ?></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
